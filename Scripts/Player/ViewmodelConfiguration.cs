...
public class ViewmodelConfiguration {
	...
	public static readonly ViewmodelConfiguration ShootConfiguration = new ViewmodelConfiguration(NormalConfiguration.Position, NormalConfiguration.Rotaton, 40.0f);
